...
import { resolveBundledAlgorithm, bundledAlgorithms } from "@xoji/core/host/bundle";
 ...
 * (`@xoji/core/host/bundle`), which embeds each blessed mod so no bundler-specific import is needed. The
