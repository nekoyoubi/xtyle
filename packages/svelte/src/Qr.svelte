<script lang="ts">
	...
	interface Props {
		...
		quietZone?: number;
		label?: string;
		/** Any other attribute (`id`, `style`, `class`, `data-*`, `aria-*`, …) passes through. */
		[key: string]: unknown;
	}
