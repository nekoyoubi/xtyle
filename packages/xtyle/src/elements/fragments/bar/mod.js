...
(() => {
  ...
  function barClass(b) {
    ...
    return ["xtyle-bar", horizontal && "xtyle-bar--horizontal", b.stacked && "xtyle-bar--stacked", b.selectable && "xtyle-bar--selectable"].filter(Boolean).join(" ");
  }
  ...
  function verticalPlot(b, series, colors, height) {
    ...
    return `<g class="xtyle-bar__grid-layer">${grid}</g>${baseline}<g class="xtyle-bar__bars">${rects.join("")}</g><g class="xtyle-bar__values">${valueLabels.join("")}</g><g class="xtyle-bar__xlabels">${xLabels.join("")}</g>`;
  }
  function horizontalPlot(b, series, colors, height) {
    ...
    return `<g class="xtyle-bar__grid-layer">${grid}</g>${baseline}<g class="xtyle-bar__bars">${rects.join("")}</g><g class="xtyle-bar__values">${valueLabels.join("")}</g><g class="xtyle-bar__ylabels">${catLabels.join("")}</g>`;
  }
  function barHtml(b) {
