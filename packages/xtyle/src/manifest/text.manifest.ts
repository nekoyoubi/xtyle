...
const htmlExample = `<xtyle-text>The quiet default: body copy at comfortable measure.</xtyle-text>
...
export const textManifest: ComponentManifest = {
	...
	variants: [
		...
		},
		{
			...
			className: "xtyle-text--accent",
			tokens: ["--accent-vivid"],
		},
		{
			name: "mono",
			description: "Monospace family for inline code and tabular figures; composes with any tone or size.",
			className: "xtyle-text--mono",
			tokens: ["--font-mono"],
		},
	],
	sizes: [
		{ name: "xs", description: "Smallest: fine print.", className: "xtyle-text--xs" },
		{ name: "sm", description: "Small: secondary copy.", className: "xtyle-text--sm" },
		{ name: "body", description: "Default reading size.", className: "xtyle-text", isDefault: true },
		{ name: "lg", description: "Large: lead paragraphs.", className: "xtyle-text--lg" },
	],
	states: [],
	slots: [
		{
