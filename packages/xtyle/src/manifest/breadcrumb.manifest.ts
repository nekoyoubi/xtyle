...
const htmlExample = `<xtyle-breadcrumb
	items='[
		{"label":"Home","href":"/"},
...
const interactiveHtmlExample = `<xtyle-breadcrumb id="tree-trail" label="Node ancestry" items='[
	{"label":"root","value":"0"},
...
export const breadcrumbManifest: ComponentManifest = {
	...
	anatomy: [
		...
		},
		{
			...
			selector: ".xtyle-breadcrumb__list",
			tokens: ["--space-1"],
		},
		{
			name: "item",
			...
			selector: ".xtyle-breadcrumb__link, .xtyle-breadcrumb__current",
		...
		},
		{
			...
			selector: ".xtyle-breadcrumb__separator",
			tokens: ["--fg-3"],
		},
	],
	props: [
	...
	variants: [
		{
			...
			className: "xtyle-breadcrumb--accent",
			tokens: ["--accent-vivid"],
		},
		{
			name: "neutral",
			description: "Ancestor links in neutral ink for a quieter trail.",
			className: "xtyle-breadcrumb--neutral",
			tokens: ["--neutral-vivid"],
		},
	],
	sizes: [
		{ name: "sm", description: "Compact.", className: "xtyle-breadcrumb--sm" },
		{ name: "md", description: "Default.", className: "xtyle-breadcrumb", isDefault: true },
		{ name: "lg", description: "Large.", className: "xtyle-breadcrumb--lg" },
	],
	states: [
		{
			name: "hover",
			description: "Pointer over an ancestor link; it underlines.",
			selector: ".xtyle-breadcrumb__link:hover",
		},
		{
			name: "focus-visible",
			...
			selector: ".xtyle-breadcrumb__link:focus-visible",
