...
const htmlExample = `<xtyle-badge variant="soft" tone="accent">New</xtyle-badge>
...
const pulseHtmlExample = `<xtyle-badge variant="soft" tone="success" dot pulse>Live</xtyle-badge>
...
export const badgeManifest: ComponentManifest = {
	...
	variants: [
		...
		},
		{
			...
			className: "xtyle-badge--outline",
			tokens: ["--accent", "--accent-text", "--color-blue-strong", "--color-blue-muted"],
		},
	],
	sizes: [
		{ name: "sm", description: "Compact.", className: "xtyle-badge--sm" },
		{ name: "md", description: "Default.", className: "xtyle-badge", isDefault: true },
		{ name: "lg", description: "Large.", className: "xtyle-badge--lg" },
	],
	states: [
		{
			name: "pulse",
			...
			selector: ".xtyle-badge--pulse-slow .xtyle-badge__dot, .xtyle-badge--pulse-fast .xtyle-badge__dot",
			tokens: ["--ease-standard"],
		},
		{
			name: "remove-hover",
			description: "Pointer over the dismiss button. Its overlay paints the hover tint.",
			selector: ".xtyle-badge__remove:hover::after",
			tokens: ["--state-hover"],
		},
		{
			name: "remove-active",
			description: "Dismiss button pressed. Its overlay paints the press tint.",
			selector: ".xtyle-badge__remove:active::after",
			tokens: ["--state-press"],
		},
		{
			...
			selector: ".xtyle-badge__remove:focus-visible",
