...
export const appShellManifest: ComponentManifest = {
	...
	props: [
		...
		},
		{
			...
			type: "number",
			default: "160",
			description: "Lower clamp, in px, for the resizable left rail (`left-min`).",
			bindings: ["html", "svelte", "astro"],
		},
		{
			name: "leftMax",
			type: "number",
			default: "720",
			description: "Upper clamp, in px, for the resizable left rail (`left-max`).",
			bindings: ["html", "svelte", "astro"],
		},
		{
			name: "rightMin",
			type: "number",
			default: "160",
			description: "Lower clamp, in px, for the resizable right rail (`right-min`).",
			bindings: ["html", "svelte", "astro"],
		},
		{
			name: "rightMax",
