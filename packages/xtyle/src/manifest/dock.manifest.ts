...
const htmlExample = `<xtyle-dock label="Navigation" nav side="left">
	<a href="/dashboard">Dashboard</a>
	<a href="/projects">Projects</a>
	<a href="/settings">Settings</a>
</xtyle-dock>

<xtyle-dock label="Inspector" side="right" size="sm">
	<p>Properties for the selected item appear here.</p>
	<small slot="footer">Last saved a moment ago.</small>
</xtyle-dock>`;

const svelteExample = `<script lang="ts">
	import { Dock } from "@xtyle/svelte";
</script>
	...
	variants: [
		{
			...
			className: "xtyle-dock",
			tokens: ["--border-thin", "--line"],
		},
		{
			name: "right",
			description: "Pinned to the right edge with the divider on its left.",
			className: "xtyle-dock--right",
			tokens: ["--border-thin", "--line"],
		},
		{
			name: "edge-out",
			description: "Edge moved to the rail's outer side instead of the inner divider.",
			className: "xtyle-dock--edge-out",
		},
		{
			name: "edge-bold",
			description: "A chunky accent spine instead of the default thin edge.",
			className: "xtyle-dock--edge-bold",
			tokens: ["--space-1"],
		},
	],
	sizes: [
		{ name: "sm", description: "Narrow rail, 14rem.", className: "xtyle-dock--sm" },
		{ name: "md", description: "Default rail, 18rem.", className: "xtyle-dock", isDefault: true },
		{ name: "lg", description: "Wide rail, 22rem.", className: "xtyle-dock--lg" },
	],
	states: [],
	slots: [
		{
