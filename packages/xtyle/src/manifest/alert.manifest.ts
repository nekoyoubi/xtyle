...
const htmlExample = `<xtyle-alert tone="info" variant="soft">
	<span slot="title">Heads up</span>
	Your changes are saved locally and will sync when you reconnect.
</xtyle-alert>

<xtyle-alert tone="success" variant="soft">Profile updated.</xtyle-alert>

<xtyle-alert tone="danger" variant="solid" dismissible>
	<span slot="title">Upload failed</span>
	The file exceeded the 25 MB limit.
	<span slot="actions">
		<xtyle-button variant="outline" tone="danger">Try again</xtyle-button>
	</span>
</xtyle-alert>`;

const svelteExample = `<script lang="ts">
	import { Alert, Button } from "@xtyle/svelte";
</script>
...
const astroExample = `---
import { Alert, Button } from "@xtyle/astro";
---
...
export const alertManifest: ComponentManifest = {
	...
	states: [
		...
		},
		{
			...
			selector: ".xtyle-alert__dismiss:focus-visible",
