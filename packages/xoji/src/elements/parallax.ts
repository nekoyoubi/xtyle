 ...
 */
export class XojiParallax extends HTMLElement {
	...
	private applyMinHeight(): void {
		...
		if (value) this.style.setProperty("--xoji-parallax-min-height", value);
		else this.style.removeProperty("--xoji-parallax-min-height");
	}
...
define("xoji-parallax", XojiParallax);
