...
const htmlExample = `<xoji-sparkline values="4,6,5,8,7,9,12,10,13" label="Weekly signups"></xoji-sparkline>

<xoji-sparkline values="4,6,5,8,7,9,12,10,13" variant="area" tone="success"></xoji-sparkline>

<xoji-sparkline values="4,6,5,8,7,9,12,10,13" variant="bar" tone="purple"></xoji-sparkline>`;
...
const inlineHtmlExample = `<p>
	Signups this week
	<xoji-sparkline values="4,6,5,8,7,9,12,10,13" tone="accent" style="--spark-width: 5rem; --spark-height: 1.2rem;"></xoji-sparkline>
	up 34%.
</p>`;
...
export const sparklineManifest: ComponentManifest = {
	...
	variants: [
		{ name: "line", description: "A stroked trend line, the default.", className: "xoji-sparkline--line" },
		{ name: "area", description: "The line with a soft fill down to the baseline.", className: "xoji-sparkline--area" },
		{ name: "bar", description: "A run of tiny bars, one per value.", className: "xoji-sparkline--bar" },
	],
	sizes: [],
	states: [
		{
