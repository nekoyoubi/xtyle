...
const htmlExample = `<xoji-carousel label="Product photos">
	<img src="/a.jpg" alt="Front" />
	<img src="/b.jpg" alt="Side" />
	<img src="/c.jpg" alt="Back" />
</xoji-carousel>`;

const autoplayHtmlExample = `<xoji-carousel label="Highlights" autoplay interval="4000" loop>
	<div>Slide one</div>
	<div>Slide two</div>
	<div>Slide three</div>
</xoji-carousel>`;
...
const autoplaySvelteExample = `<script lang="ts">
	import { Carousel } from "@xoji/svelte";
</script>
...
import Carousel from "@xoji/astro/Carousel.astro";
---
