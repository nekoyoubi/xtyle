...
const htmlExample = `<xoji-avatar-group label="Contributors" overflow="3">
	<xoji-avatar alt="Ada Lovelace" tone="accent">AL</xoji-avatar>
	<xoji-avatar alt="Alan Turing" tone="success">AT</xoji-avatar>
	<xoji-avatar alt="Grace Hopper" tone="warn">GH</xoji-avatar>
	<xoji-avatar alt="Katherine Johnson" tone="info">KJ</xoji-avatar>
</xoji-avatar-group>`;

const svelteExample = `<script lang="ts">
	import { AvatarGroup, Avatar } from "@xoji/svelte";
...
const astroExample = `---
import { AvatarGroup, Avatar } from "@xoji/astro";
const people = [
	{ name: "Ada Lovelace", initials: "AL", tone: "accent" },
	{ name: "Alan Turing", initials: "AT", tone: "success" },
	{ name: "Grace Hopper", initials: "GH", tone: "warn" },
...
const sizeHtmlExample = `<xoji-avatar-group size="sm" spacing="snug" overflow="12" label="Viewers">
	<xoji-avatar alt="Ada" tone="accent" size="sm">AD</xoji-avatar>
	<xoji-avatar alt="Alan" tone="success" size="sm">AL</xoji-avatar>
	<xoji-avatar alt="Grace" tone="warn" size="sm">GR</xoji-avatar>
</xoji-avatar-group>`;
...
export const avatarGroupManifest: ComponentManifest = {
	...
	variants: [],
	sizes: [
		{ name: "sm", description: "Compact, for dense lists.", className: "xoji-avatar-group--sm" },
		{ name: "md", description: "Default.", className: "xoji-avatar-group", isDefault: true },
		{ name: "lg", description: "Large, for headers.", className: "xoji-avatar-group--lg" },
		{ name: "xl", description: "Extra large.", className: "xoji-avatar-group--xl" },
	],
	states: [
		{
			name: "avatar-hover",
			description: "Hovering or focusing an avatar raises it above its neighbours so a covered face reads in full.",
			selector: ".xoji-avatar-group ::slotted(*:hover)",
			tokens: [],
		},
	],
	slots: [
