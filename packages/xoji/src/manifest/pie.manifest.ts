...
const htmlExample = `<xoji-pie label="Traffic by source"></xoji-pie>
<script>
...
const donutHtmlExample = `<xoji-pie variant="donut" scheme="accents" label="Budget"></xoji-pie>
<script>
	document.querySelector("xoji-pie").data = [
...
export const pieManifest: ComponentManifest = {
	...
	variants: [
		{ name: "pie", description: "A full pie of solid wedges.", className: "xoji-pie" },
		{ name: "donut", description: "A ring with the total in its center.", className: "xoji-pie--donut" },
	],
	sizes: [],
	states: [
		{
			...
			selector: ".xoji-pie--hovering .xoji-pie__slice:not(.is-active)",
		...
		},
		{
			...
			selector: ".xoji-pie__slice:focus-visible",
