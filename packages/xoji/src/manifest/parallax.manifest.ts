...
const htmlExample = `<xoji-parallax min-height="24rem" amplitude="140">
...
const cursorExample = `<xoji-parallax min-height="24rem" mode="cursor" amplitude="50">
...
const svelteExample = `<script lang="ts">
	import { Parallax, Heading, Text } from "@xoji/svelte";
</script>
...
const astroExample = `---
import Parallax from "@xoji/astro/Parallax.astro";
